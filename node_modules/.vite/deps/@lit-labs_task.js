...
var Task = class {
  ...
  async performTask() {
    var _a2;
    const args = (_a2 = this._getArgs) === null || _a2 === void 0 ? void 0 : _a2.call(this);
  ...
  async run(args) {
    ...
    args !== null && args !== void 0 ? args : args = (_a2 = this._getArgs) === null || _a2 === void 0 ? void 0 : _a2.call(this);
    if (this.status !== TaskStatus.PENDING) {
    ...
    if (this._callId === key) {
      if (result === initialState) {
        ...
        if (error === void 0) {
          try {
            (_b2 = this._onComplete) === null || _b2 === void 0 ? void 0 : _b2.call(this, result);
          } catch {
          }
          this.status = TaskStatus.COMPLETE;
          (_c2 = this._resolveTaskComplete) === null || _c2 === void 0 ? void 0 : _c2.call(this, result);
        } else {
          try {
            (_d2 = this._onError) === null || _d2 === void 0 ? void 0 : _d2.call(this, error);
          } catch {
          }
          this.status = TaskStatus.ERROR;
          (_e2 = this._rejectTaskComplete) === null || _e2 === void 0 ? void 0 : _e2.call(this, error);
        }
        this._value = result;
        this._error = error;
      }
  ...
  render(renderer) {
    ...
    switch (this.status) {
      case TaskStatus.INITIAL:
        return (_a2 = renderer.initial) === null || _a2 === void 0 ? void 0 : _a2.call(renderer);
      case TaskStatus.PENDING:
        return (_b2 = renderer.pending) === null || _b2 === void 0 ? void 0 : _b2.call(renderer);
      case TaskStatus.COMPLETE:
        return (_c2 = renderer.complete) === null || _c2 === void 0 ? void 0 : _c2.call(renderer, this.value);
      case TaskStatus.ERROR:
        return (_d2 = renderer.error) === null || _d2 === void 0 ? void 0 : _d2.call(renderer, this.error);
      default:
        this.status;
    }
  }
...
@lit-labs/task/development/index.js:
   ...
   *)
*/
//# sourceMappingURL=@lit-labs_task.js.map
