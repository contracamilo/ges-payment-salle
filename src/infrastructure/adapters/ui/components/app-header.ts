...
export class AppHeader extends BaseComponent {
  ...
  private isActive(url: string): boolean {
    ...
    if (url === '/estudiantes') {
      ...
      return path === url || (path.startsWith(url + '/') && !path.includes('/pagos'));
    }
      ...
      <header class="p-3 bg-dark text-white shadow-none">
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <ul
              class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 mx-auto"
            >
              <li>
                <a
                  class="nav-link px-3 ${this.isActive('/estudiantes')
              ...
              <li>
                <a
                  class="nav-link px-3 ${this.isActive('/pagos')
                    ? 'active fw-bold text-white'
                    : 'text-white'}"
                  href="/pagos"
                  @click=${(e: Event) => {
            ...
            <div class="text-end d-flex align-items-center">
              <form class="me-2 d-none d-md-block">
                <input
                  ...
                  placeholder="Buscar..."
                  aria-label="Search"
                  style="background-color: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.1); color: white;"
                />
              </form>
              ...
              <div class="dropdown">
                ...
                ${this.showUserMenu
                  ? html`
                      <ul
                        class="dropdown-menu dropdown-menu-dark dropdown-menu-end text-small shadow show"
                        style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 40px);"
                      >
                        <li>
                          <a class="dropdown-item" href="#"
                            ><i class="fas fa-project-diagram me-2"></i>Nuevo proyecto</a
                          >
                        </li>
                        <li>
                          <a class="dropdown-item" href="#"
