  ...
  private async handleSubmit(e: Event) {
    ...
    try {
      ...
      if (!this.selectedStudent && this.formData.estudianteId) {
        try {
          this.selectedStudent = await window.services.studentUseCase.getStudentByCode(
            this.formData.estudianteId
          );
          if (!this.selectedStudent) {
            throw new Error(
              `No se encontró el estudiante con código ${this.formData.estudianteId}`
            );
          }
        } catch (error) {
            ...
            <div class="modal-body">
              <form @submit=${this.handleSubmit}>
                  ...
                  ${this.selectedStudent
                        ...
                        <div class="d-flex align-items-center border rounded p-2 mb-2">
                          <div class="flex-grow-1">
                            ...
                            <div class="small text-muted">
                              Código: ${this.selectedStudent.codigo}
                            </div>
                          </div>
                          <button
                            type="button"
                            class="btn btn-sm btn-outline-secondary"
                            @click=${this.clearSelectedStudent}
                          >
                    ...
                    : html`
                        <div class="mb-2">
                          ...
                          />
                          ${this.errors.estudianteId
                            ? html`<div class="invalid-feedback">${this.errors.estudianteId}</div>`
                            : ''}
                        </div>
                                    ...
                                    >
                                      <div>
                                        ...
                                        <small class="d-block text-muted"
                                          >Programa: ${student.programaId}</small
                                        >
                                      </div>
                ...
                <div class="mb-3">
                  ...
                  />
                  ${this.errors.fecha
                    ? html`<div class="invalid-feedback">${this.errors.fecha}</div>`
                    : ''}
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    />
                    ${this.errors.monto
                      ? html`<div class="invalid-feedback">${this.errors.monto}</div>`
                      : ''}
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  >
                    ${Object.values(PaymentType).map(
                      type => html` <option value=${type}>${this.formatPaymentType(type)}</option> `
                    )}
                  </select>
                </div>
